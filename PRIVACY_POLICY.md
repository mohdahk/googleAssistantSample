Welcome to the Google Assistant test app for Android!

This is an open source Android app developed by Ameer Hamza. The source code is available on GitHub; the app is also available on Google Play.
